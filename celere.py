...
def cadastro_cliente(cpf, nome, genero, endereco, cep, foto_path):
    ...
    if not cpf or not nome or not genero or not cep or not foto_path:
        print("Dados do cliente incompletos. O cadastro não pode ser concluído.")
        return False
    ...
    try:
        ...
        print(f"Erro ao cadastrar cliente no banco de dados: {e}")
        return False
...
if verificar_face('teste.jpg'):
    ...
    print("A verificação facial falhou. Usuário não autorizado.")
